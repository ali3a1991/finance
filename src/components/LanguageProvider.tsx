...
const translations = {
  de: {
    ...
    investments: {
      ...
      marketStatus: "Aktueller Marktstand",
      chartTitle: "Gewinn und Verlust in Euro",
      chartDescription: "Berechnet mit dem letzten verfügbaren Marktpreis. Nicht verfügbare Kurse werden ausgelassen.",
    ...
    settings: {
      ...
      permissionSections: { dashboard: "Dashboard", incomes: "Einnahmen", expenses: "Ausgaben", savings: "Sparen", investments: "Investitionen", loans: "Kredite", insurances: "Versicherungen", contracts: "Verträge", projects: "Projekte", shopping: "Einkaufsliste" },
  ...
  en: {
    ...
    investments: {
      ...
      chartTitle: "Gain and loss in euros",
      chartDescription: "Calculated using the latest available market price. Unavailable quotes are excluded.",
    ...
    settings: {
      ...
      selectAll: "Select all",
      clearAll: "Clear all",
      permissionSections: { dashboard: "Dashboard", incomes: "Income", expenses: "Expenses", savings: "Savings", investments: "Investments", loans: "Loans", insurances: "Insurance", contracts: "Contracts", projects: "Projects", shopping: "Shopping list" },
