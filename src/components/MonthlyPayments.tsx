...
import type { DashboardSummary, MonthlyPayment } from "@/lib/types";
...
export function MonthlyPayments({ view = "full" }: { view?: "summary" | "full" }) {
  const { can } = useAuth();
  ...
  return (
    <>
      ...
      {!isSummaryView ? <section className="payment-panel">
